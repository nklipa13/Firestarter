...
import ProjectAddProposalModal from './ProjectAddProposalModal/ProjectAddProposalModal';
...
export const PROJECT_ADD_PROPOSAL_MODAL = 'PROJECT_ADD_PROPOSAL_MODAL';
...
export default {
  ...
  [PROJECT_ADD_PROPOSAL_MODAL]: ProjectAddProposalModal,
};
